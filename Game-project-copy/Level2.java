...
public class Level2 extends World
{
    ...
    private void prepare()
    {
        ...
        security3.setLocation(163, 267);
        security2.setLocation(415, 431);
        removeObject(security5);
        security2.setLocation(417, 361);
        security4.setLocation(628, 466);
        security6.setLocation(791, 267);
        security7.setLocation(865, 414);
        security2.setLocation(435, 160);
        security4.setLocation(416, 480);
        security7.setLocation(697, 478);
    }
}
